    ...
    char** argv )
{
    ...
    cl_uint* h_src = (cl_uint*)clSVMAllocWithPropertiesKHR(
        context(),
        nullptr,
        index,
        gwx * sizeof(cl_uint),
        nullptr );
    cl_uint* h_dst = (cl_uint*)clSVMAllocWithPropertiesKHR(
        context(),
        nullptr,
        index,
        gwx * sizeof(cl_uint),
    ...
    if( h_src && h_dst )
    {
        ...
        // execution
        kernel.setArg(0, h_dst);
        kernel.setArg(1, h_src);
