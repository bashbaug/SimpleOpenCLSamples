    ...
    char** argv )
{
    ...
    cl_uint* s_src = (cl_uint*)clSVMAllocWithPropertiesKHR(
        context(),
        props,
        index,
        gwx * sizeof(cl_uint),
        nullptr );
    cl_uint* s_dst = (cl_uint*)clSVMAllocWithPropertiesKHR(
        context(),
        props,
        index,
        gwx * sizeof(cl_uint),
    ...
    if( s_src && s_dst )
    {
        ...
        // execution
        kernel.setArg(0, s_dst);
        kernel.setArg(1, s_src);
